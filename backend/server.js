...
// MongoDB connection DISABLED for Railway debugging
console.log('⚠️ MongoDB connection DISABLED - using in-memory storage for now');

// TODO: Re-enable MongoDB after basic server is working
// const mongoUrls = [
